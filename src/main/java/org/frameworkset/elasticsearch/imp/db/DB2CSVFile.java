 ...
 * @Date 2021/2/1 14:39
 */
public class DB2CSVFile {
    private static Logger logger = LoggerFactory.getLogger(DB2CSVFile.class);

    public static void main(String[] args) {
        //LocalPoolDeployer.addShutdownHook = true;//在应用程序stop.sh时，关闭数据源错误提示
        //启动数据采集
        DB2CSVFile db2file = new DB2CSVFile();
    ...
    public static void scheduleTimestampImportData() {
        ...
        fileFtpOupputConfig.setFilenameGenerator(new FilenameGenerator() {
            ...
            public String genName(TaskContext taskContext, int fileSeq) {
                ...
                return "师大2021年新生医保（2021年）申报名单-合并.csv";
            }
        });
