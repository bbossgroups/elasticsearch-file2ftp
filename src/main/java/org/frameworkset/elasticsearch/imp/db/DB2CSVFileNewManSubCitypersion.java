 ...
 * @Date 2021/2/1 14:39
 */
public class DB2CSVFileNewManSubCitypersion {
    private static Logger logger = LoggerFactory.getLogger(DB2CSVFileNewManSubCitypersion.class);

    public static void main(String[] args) {
        //LocalPoolDeployer.addShutdownHook = true;//在应用程序stop.sh时，关闭数据源错误提示
        //启动数据采集
        DB2CSVFileNewManSubCitypersion db2file = new DB2CSVFileNewManSubCitypersion();
