 ...
 * @Date 2021/2/1 14:39
 */
public class DB2ExcelSplitFile {
    private static Logger logger = LoggerFactory.getLogger(DB2ExcelSplitFile.class);

    public static void main(String[] args) {
        //LocalPoolDeployer.addShutdownHook = true;//在应用程序stop.sh时，关闭数据源错误提示
        //启动数据采集
        DB2ExcelSplitFile db2ExcelFile = new DB2ExcelSplitFile();
    ...
    public static void scheduleTimestampImportData() {
        ...
        fileFtpOupputConfig.setMaxFileRecordSize(2000);
